...
const DEFAULT_DB: DBShape = {
  materials: [
    { id: 1, material_name: '20mm', unit: 'CFT', rate: 0, gst_percent: 5, hsn_code: '251710', stock_tons: 0, stock_value: 0, min_stock: 0 },
    { id: 2, material_name: '10mm', unit: 'CFT', rate: 0, gst_percent: 5, hsn_code: '251710', stock_tons: 0, stock_value: 0, min_stock: 0 },
    { id: 3, material_name: '40mm', unit: 'CFT', rate: 0, gst_percent: 5, hsn_code: '251710', stock_tons: 0, stock_value: 0, min_stock: 0 },
    { id: 4, material_name: '65mm', unit: 'CFT', rate: 0, gst_percent: 5, hsn_code: '251710', stock_tons: 0, stock_value: 0, min_stock: 0 },
    { id: 5, material_name: 'River Sand', unit: 'CFT', rate: 0, gst_percent: 5, hsn_code: '250510', stock_tons: 0, stock_value: 0, min_stock: 0 },
  ],
  parties: [],
  slips: [],
  invoices: [],
  ledger: [],
  counters: { slip: 1000, invoice: 100, ledger: 1 },
  bizInfo: {
