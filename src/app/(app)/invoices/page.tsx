...
import { dateRangeFilter, fmt, payClass, payLabel, today } from '@/lib/helpers';
      ...
      <div className="card">
        {db.invoices.length === 0 ? (
          ...
          <div className="tbl">
            <table>
              <thead>
                <tr><th>Invoice #</th><th>Date</th><th>Party</th><th>Material</th><th>Quantity</th><th>Total</th><th>GST Type</th><th>Payment</th><th>View</th><th>Share</th></tr>
              </thead>
              <tbody>
                {filtered.length === 0 ? (
                  <tr><td colSpan={10}><div className="empty"><div className="empty-icon">🔍</div>No invoices found for selected filters</div></td></tr>
                  ...
                  return (
                    <Fragment key={inv.invoice_id}>
                      <tr>
                        ...
                        <td><span className={`badge ${ip ? 'bg' : 'bb'}`}>{ip ? 'CGST+SGST' : 'IGST'}</span></td>
                      ...
                      {openShare === inv.invoice_id && (
                        <tr>
                          <td colSpan={10} style={{ padding: '0 12px 12px' }}><SharePanel obj={inv} /></td>
                        </tr>
                      )}
                    </Fragment>
                  );
